...
*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*/
	...
	public function resizeImage($newWidth, $newHeight, $option = 0, $sharpen = false, $autoRotate = false)
		...
		#
		#         $option can also be an array containing home for
		...
		#
		#       forceStretch can be applied to home 1,2,3 and 4
		#
	{

		// *** We can pass in an array of home to change the crop position
		$cropPos = 'm';
 ...
 *
 *      ===============================
 *      Image home - can run none, one, or all.
 *      ===============================
 *
 *      //  *** Add watermark
 ...
 *
 *      ===============================
 *      Output home - can run one, or the other, or both.
 *      ===============================
 *
 *      // *** Save image to disk
 ...
 *
 *      ===============================
 *      Return home - return errors. nice for debuggin.
 *      ===============================
 *
 *      // *** Return error array
 ...
 *
 *      ===============================
 *      Cleanup home - not really neccessary, but good practice
 *      ===============================
 *
 *      // *** Free used memory
